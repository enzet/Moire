...
tests = {
    "html": [
        ...
        ["plain  text", "plain text", "Double space in plain text"],
        ["  plain  text  ", " plain text ", "Spaces around plain text"],
        ["\\b{bold}", "<b>bold</b>", "Simple tag"],
        ["\\b {bold}", "<b>bold</b>", "Simple tag with space"],
        ["\\b {bold}", "<b>bold</b>", "Simple tag with two spaces"],
        ["\\code {code}", "<pre><tt>code</tt></pre>", "Verbatim"],
        ["\\\\b \\{\\}", "\\b {}", "Escaped tags"],
        ["\\b {\\}}", "<b>}</b>", "Escaped tags in tag"],
        ["<&>", "&lt;&amp;&gt;", "Escaped symbols"],
        ["&nbsp;", "&amp;nbsp;", "Escaped"],
        [
            "\\code {<&>&nbsp;}",
        ...
        ["\\b {  bold  }", "<b> bold </b>", "Simple tag with spaces"],
        ["\\b {bold}text", "<b>bold</b>text", "Simple tag and plain text"],
        [
            "\\b {bold} text",
            "<b>bold</b> text",
            "Simple tag and plain text with space",
        ],
        ["text\\b {bold}text", "text<b>bold</b>text", "Text around tag"],
        [
            "text \\b {bold} text",
            "text <b>bold</b> text",
        ...
        ["\\b{bold}\\i{italic}", "<b>bold</b><i>italic</i>", "Two tags"],
        [
            "\\b{bold} \\i{italic}",
            "<b>bold</b> <i>italic</i>",
            "Two tags with space",
