...
def construct_book(input_file_name, kind, language, rules, book_level,
        output_file_name):
    ...
    markup_format.language = language
    markup_format.caption = '_'
    markup_format.level = 0
    markup_format.root = '/Users/Enzet/Program/Book/_'
    markup_format.image = False
    markup_format.options = {}
    ...
    lexemes, positions = lexer(result)
    index = 0
    intermediate_representation = get_intermediate(lexemes, positions, markup_format.level)
